  ...
  return (
    ...
    <div className="p-4 md:p-12 overflow-y-auto flex justify-center w-full  ">
      ...
      <div className="w-full p-4  md:p-12 overflow-y-auto scroll-smooth h-screen md:min-h-screen flex flex-col">
        ...
        {LoadingMyRequest ? (
          <div loading={LoadingMyRequest}></div>
        ) : NoMyRequest ? (
      ...
      <div>
        ...
        >
          <form onSubmit={accMember}>
            <DialogHeader>
            <Typography className=" text-secondary text-center font-bold" variant="h4">Notification Menerima Request </Typography>

            </DialogHeader>
            <DialogBody divider className="grid place-items-center gap-4">
            <Typography className="text-center font-bold" color="black" variant="h4">
            {selectedProject.title}
          </Typography>
            <Typography className="text-center font-bold">
            Yakin ingin menerima Request dari Mahasiswa dengan nim {selectedRequest.userID} ?
          </Typography>
      ...
      <div>
        ...
        >
          <form onSubmit={DeclineMember}>
            <DialogHeader>           
              <Typography className=" text-primary text-center font-bold" variant="h4">Notification Menolak Request </Typography>
              </DialogHeader>
            <DialogBody divider className="grid place-items-center gap-4">
              <Typography className="text-center font-bold" color="black" variant="h4">{selectedProject.title}</Typography>
              <h2>Yakin ingin Menolak Request dari Mahasiswa dengan nim {selectedRequest.userID} ?</h2>
