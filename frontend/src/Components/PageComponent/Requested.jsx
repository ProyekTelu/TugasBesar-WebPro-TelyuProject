        ...
        <div className=" flex justify-center w-full ">
            ...
            <div className="w-full mx-auto grid md:grid-cols-1 gap-4  xs:grid-cols-1  xs:gap-4">
                <div className='flex justify-between gap-5'>
                    ...
                    <label className=" text-3xl font-bold sm:w-min xs:w-min">REQUESTED</label>

                    <input className=" transition-transform transform hover:scale-110  flex space-x-4 placeholder:italic align-middle w-auto
                     ...
                     focus:ring-sky-500 focus:ring-1 sm:text-sm" placeholder="Search..." type="text" name="search"
                ...
                <div className=" flex flex-col ">
                    <div className='  w-full shadow-xl flex flex-col lg:flex-row p-4 my-4 rounded-lg hover:scale-105 duration-300 py-12 px-6  bg-silver  '>
                        ...
                        <img className='flex-none rounded-full  w-32 h-32 mx-1 bg-black' src={""} alt="/" />
                    ...
                    {modal && (
                        <div onClick={toggleModal} className=" fixed top-0 left-0 w-full h-full flex items-center justify-center z-50 bg-opacity-5 backdrop-blur-sm">
                            ...
                            <div className="modal-container transition-transform transform hover:scale-110">
                                ...
                                <div className= " bg-gray-50 rounded-lg shadow-xl p-8">
                                    ...
                                    <h2 className=" text-2xl font-semibold my-auto">Requested From {"Naufal"}</h2>
                                    <button
                                        onClick={toggleModal}

                                        className=" my-auto focus:outline-none transition-transform transform hover:scale-110"
                                    ><AiFillCloseCircle className='text-4xl'/></button>
                                    </div>
                                    ...
                                    <div className=' flex flex-row gap-4 w-full align-bottom  justify-center'>
                                        <button className='  hover:bg-green-400  transition-transform transform hover:scale-110 p-4  bg-green-500  w-32  rounded-md  text-white'>Approve</button>
                                        <button className='  hover:bg-red-400 transition-transform transform hover:scale-110  p-4 bg-red-500 w-32  rounded-md text-white'>Decline</button>
                                    </div>
