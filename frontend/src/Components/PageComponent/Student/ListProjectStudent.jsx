        ...
        isShowRequestForm ?
          ...
          <>
            <div className="flex justify-between">
              ...
              />
              <input type="text" className="text-black py-2 px-3 bg-white border-2 rounded-lg focus:outline-greyAlternative focus:bg-whiteAlternative"
                placeholder="Search" />
            </div>
            <CardListProject items={currentItems} handleRequestForm={(title) => {
